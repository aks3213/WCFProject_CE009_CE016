<%@ Page Language="C#"  MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Students.aspx.cs" Inherits="ClientWeb.pages.Student" %>
            ...
            <table style="font-family: Arial; border: 1px solid black;">
                ...
                <tr>
                    <td class="auto-style1">
                        <asp:Button ID="GetUser" runat="server" OnClick="GetUser_Click" Text="Get User" />
                    </td>
